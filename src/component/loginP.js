...
// })
export default connect(mapStateToProps)(function PictureOfToday(props) {
    const { users } = props;
        ...
        <>
            <div style={{ marginLeft: "30%" }}  ><h1 style={{ color: "green" }}>Picture Of The Day</h1>
                <div className="card" className="apod" style={{ width: "25rem" }}>
                    ...
                    {/* {picture.media_type === "video" && <iframe src={pictureUrl} width="50px" controls="controls" autoplay="autoplay"></iframe>} */}
                    {/* {picture.media_type === "image" && <img src={picture.url}width="400px" className="card-img-top" alt="img" />} */}
