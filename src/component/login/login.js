  ...
  return (
    ...
    <div className="inner-container">
      ...
      <div className="header">
        <p style={{ display: 'inline-block', borderBottom: "2px solid" }}> Log in</p>
        <p style={{ display: 'inline-block', paddingLeft: "20px" }} onClick={() => history.push('/SignUP')}> Sign up</p>
      </div>

      <div className="box">
        <div className="input-group">
          <label htmlFor="email">email</label>
          <input type="text" name="email" className="login-input" onChange={(e) => setEmail(e.target.value)} placeholder="email" />
        </div>

        <div className="input-group">
          <label htmlFor="password">Password</label>
          <input type="password" name="password" className="login-input" onChange={(e) => setpassward(e.target.value)} placeholder="Password" />
        </div>
        <button type="button" className="login-btn" onClick={submitLogin}>Login</button>
        <button type="button" className="login-btn" onClick={submitLogin1}>AllUsers</button>
